...
export default function KabaddiCTA({
  content,
}: {
  content?: Partial<typeof kabaddiContent.cta> | null;
}) {
  const data = { ...kabaddiContent.cta, ...(content ?? {}) };
  ...
  return (
    <section className="relative overflow-hidden bg-[#050B18] px-4 py-16 sm:px-6 md:py-24 lg:px-8">
      ...
      <div aria-hidden className="pointer-events-none absolute right-1/4 top-1/2 h-[560px] w-[560px] translate-x-1/2 -translate-y-1/2 rounded-full bg-[#f59e0b]/8 blur-3xl" />
