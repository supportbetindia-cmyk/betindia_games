import { UserPlus, Search, BarChart3, Wallet, CheckCircle2 } from "lucide-react";
import { kabaddiContent } from "@/data/kabaddi";

const STEP_ICONS = [UserPlus, Search, BarChart3, Wallet, CheckCircle2] as const;

export default function KabaddiHowToPlace() {
  const data = kabaddiContent.howToPlace;
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          ...
          <h2 className="mt-5 text-2xl font-extrabold leading-tight tracking-tight text-white md:text-3xl lg:text-4xl">
            How to Place a Kabaddi Bet on{" "}
            <span className="bg-gradient-to-r from-[#FF6B00] via-[#f59e0b] to-[#138808] bg-clip-text text-transparent">
              Bet India
            </span>
          </h2>
          <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-slate-400 md:text-base">{data.intro}</p>
        </div>
