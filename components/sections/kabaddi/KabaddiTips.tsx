...
export default function KabaddiTips() {
  const data = kabaddiContent.tips;
  ...
  return (
    <section className="relative overflow-hidden bg-[#050B18] px-4 py-16 sm:px-6 md:py-24 lg:px-8 border-t border-white/[0.04]">
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-8 text-sm leading-relaxed text-slate-400 sm:text-base">{data.closing}</p>
      </div>
    </section>
  );
}
