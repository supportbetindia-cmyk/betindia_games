...
export default function LiveCasinoCTA() {
  return (
        ...
        >
          <div className="relative overflow-hidden rounded-[calc(1.5rem-1px)] bg-[#081425]/95 p-8 text-center backdrop-blur-xl md:p-14">
            ...
            <p className="relative mx-auto mt-4 max-w-xl text-sm leading-relaxed text-slate-400 md:text-base">
              Experience premium live casino entertainment with real dealers, exciting games, and immersive gameplay designed for modern players.
            </p>
            ...
            <p className="relative mt-6 text-[10px] text-slate-600">18+ only · Please play responsibly · T&Cs apply</p>
          </div>
        </div>
      </div>
    </section>
