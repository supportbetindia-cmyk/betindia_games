...
export default function VolleyballCTA({
  content,
}: {
  content?: Partial<typeof volleyballContent.cta> | null;
}) {
  const data = { ...volleyballContent.cta, ...(content ?? {}) };
  ...
  return (
    <section className="relative overflow-hidden bg-[#050B18] px-4 py-16 sm:px-6 md:py-24 lg:px-8">
      ...
      <div aria-hidden className="pointer-events-none absolute right-1/4 top-1/2 h-[560px] w-[560px] translate-x-1/2 -translate-y-1/2 rounded-full bg-[#6366f1]/8 blur-3xl" />

      <div className="relative z-10 mx-auto max-w-4xl">
        <div
          className="rounded-3xl p-px"
          style={{ background: "linear-gradient(135deg, rgba(255,107,0,0.5) 0%, rgba(99,102,241,0.2) 40%, rgba(19,136,8,0.25) 100%)" }}
        >
          <div className="relative overflow-hidden rounded-[calc(1.5rem-1px)] bg-[#081425]/95 p-8 text-center backdrop-blur-xl md:p-14">
            ...
            <h2 className="relative mx-auto mt-6 max-w-2xl text-2xl font-extrabold leading-tight tracking-tight text-white md:text-3xl lg:text-4xl">
              Join BetIndia and Experience Premium Online{" "}
